...
def create_app():
    ...
    from app.blueprints.kb_articles import bp as kb_articles_bp
    from app.blueprints.kb_categories import bp as kb_categories_bp
    from app.blueprints.kb_suppliers import bp as kb_suppliers_bp
    ...
    # Register Knowledge Base blueprints
    app.register_blueprint(kb_articles_bp)
    app.register_blueprint(kb_categories_bp)
    app.register_blueprint(kb_suppliers_bp)
